...
sff.clb.stereo360Params = estimate360CameraParameters(calAlpha1(:,1:3),calAlpha2(:,1:3),sff.prm.clb.estMethod,sff);
...
elseif strcmp(estMethod,'minSearch')
    stereo360Params = tRestimate_minSearch(matchedAlpha1,matchedAlpha2,sff);

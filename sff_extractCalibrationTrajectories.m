...
sff.clb.calPoints = spreadCalPoints(sff.clb.calPoints,Inf,sff.prm.mov.frameDim);
...
%f = calPoints.p1(:,1) < 3500 & calPoints.p2(:,1) < 3500 & calPoints.p1(:,2) >350 & calPoints.p2(:,2) > 350 & calPoints.p1(:,2) < 1000 & calPoints.p2(:,2) < 1000;
